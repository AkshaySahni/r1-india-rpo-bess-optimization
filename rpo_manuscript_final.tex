...
\begin{enumerate}
    ...
    \end{align}
    Profiles are calibrated to empirical CEA and MNRE state-level solar capacity factor benchmarks: Rajasthan (24.5\%), Gujarat (23.8\%), Karnataka (22.8\%), and Tamil Nadu (22.2\%).
    ...
    \end{align}
    Profiles are calibrated to empirical CEA and MNRE state-level onshore wind capacity factor benchmarks: Tamil Nadu (36.2\%), Gujarat (33.5\%), Karnataka (31.5\%), and Rajasthan (28.5\%).
