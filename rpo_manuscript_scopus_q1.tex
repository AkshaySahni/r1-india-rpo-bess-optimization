...
\begin{enumerate}
    ...
    \end{align}
    Profiles are scaled to representative state annual capacity factor baselines reflecting single-axis tracking solar PV performance across major Indian renewable corridors: Rajasthan (24.5\%), Gujarat (23.8\%), Karnataka (22.8\%), and Tamil Nadu (22.2\%).
    ...
    \end{align}
    Profiles are scaled to representative state annual capacity factor baselines reflecting 120~m hub-height onshore wind potential across state corridors: Tamil Nadu (36.2\%), Gujarat (33.5\%), Karnataka (31.5\%), and Rajasthan (28.5\%).
